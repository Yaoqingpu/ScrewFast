export const Icons = {
  groups: {
    ...
    class: 'h-7 w-7 shrink-0 fill-blue-600 dark:fill-blue-400',
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      'mt-2 h-6 w-6 shrink-0 fill-neutral-700 hs-tab-active:fill-blue-600 dark:fill-neutral-300 dark:hs-tab-active:fill-blue-400 md:h-7 md:w-7',
    width: 48,
    height: 48,
    viewBox: '0 -960 960 960',
  },
  ...
  house: {
    ...
    class:
      'h-6 w-6 shrink-0 text-neutral-700 hs-tab-active:text-blue-600 dark:text-neutral-300 dark:hs-tab-active:text-blue-400 md:h-7 md:w-7',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  phone: {
    paths: [
      {
        d: 'M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.508-.73.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z',
      },
    ],
    class: 'mt-1.5 h-6 w-6 shrink-0 text-neutral-600 dark:text-neutral-400',
    viewBox: '0 0 24 24',
  ...
  whatsapp: {
    paths: [
      {
        d: 'M8.625 9.75a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375m-13.5 3.01c0 1.6.8 3.11 2.19 4.024C6.708 19.349 9.213 20.25 12 20.25c.993 0 1.953-.138 2.863-.395M6.228 6.228A8.952 8.952 0 0 1 12 3.75c2.787 0 5.292.901 7.24 2.406 1.39.914 2.19 2.425 2.19 4.024 0 1.6-.8 3.11-2.19 4.024A8.952 8.952 0 0 1 12 16.5a8.91 8.91 0 0 1-2.863-.471L6 18l1.228-3.228A8.91 8.91 0 0 1 6.228 6.228Z',
      },
    ],
    class: 'mt-1.5 h-6 w-6 shrink-0 text-neutral-600 dark:text-neutral-400',
    viewBox: '0 0 24 24',
